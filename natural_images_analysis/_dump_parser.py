p = '2'
with open(f'natural_images_analysis/all_analysis_p{p}.csv', mode='a') as output:
    for index in range(101):
        with open(f'natural_images_analysis/img_{index}/analysis_p{p}.csv', mode='r') as input_dump:
            i = 0
